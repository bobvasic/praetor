...
const badgeVariants = cva(
  "inline-flex items-center gap-2 rounded-md border px-3 py-1.5 font-mono text-[11px] font-semibold uppercase tracking-[0.22em]",
  {
    variants: {
      tone: {
      ...
      pulse: { true: "animate-[subtle-pulse_2.6s_ease-in-out_infinite]", false: "" },
    },
