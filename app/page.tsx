      ...
      <main>
        <Section spacing="hero">
          <Container className="grid gap-12 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
            <div>
              <FadeUp>
                <Badge tone="gold">Institutional onchain ops firewall</Badge>
              </FadeUp>
              ...
              <FadeUp delay={0.16}>
                <p className="mt-7 max-w-2xl text-xl leading-9 text-titanium/[0.82]">
                  ...
                  enables guardian challenges, and blocks unsafe execution
                  before protocol operations become incidents.
                </p>
              </FadeUp>
              <FadeUp
                delay={0.22}
                  ...
                  <div className="relative min-h-64 overflow-hidden rounded-2xl border border-arctic/[0.18] bg-obsidian/[0.72] p-5">
                    ...
                    <div className="relative flex h-full flex-col items-center justify-center text-center">
                      <div className="flex h-24 w-24 items-center justify-center rounded-[2rem] border border-arctic/[0.28] bg-arctic/[0.08] shadow-glow">
                        <LockKeyhole
                          className="h-11 w-11 text-arctic"
                          aria-hidden
                        />
                      </div>
                      <p className="mt-6 font-mono text-xs uppercase tracking-[0.24em] text-titanium/[0.58]">
                        Policy perimeter
                      </p>
