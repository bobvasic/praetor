    ...
    <TooltipProvider>
      <main>
        <section className="mx-auto grid max-w-7xl gap-12 px-6 pb-24 pt-16 md:pt-24 lg:grid-cols-[1.04fr_0.96fr] lg:items-center">
          <div>
            <FadeUp><Badge tone="gold">Institutional On-Chain Ops Firewall</Badge></FadeUp>
            <FadeUp delay={0.06} className="mt-8 max-w-md"><Wordmark /></FadeUp>
            <FadeUp delay={0.12}>
              ...
              <div className="space-y-3 p-5">
                {consoleRows.map(([kind, value, status], index) => (
                  <FadeUp key={kind} delay={0.28 + index * 0.04}>
                    <div className="grid grid-cols-[0.5fr_1fr_auto] items-center gap-4 rounded-xl border border-titanium/[0.10] bg-obsidian/[0.62] px-4 py-3 font-mono text-xs">
          ...
          <div className="mx-auto mt-12 grid max-w-7xl gap-4 md:grid-cols-4">
            {flowSteps.map((step, index) => (
              <HoverLift key={step} delay={index * 0.05}>
                <Card className="min-h-56 hover:border-arctic/[0.24] hover:shadow-glow">
                  <p className="font-mono text-xs font-bold text-arctic">0{index + 1}</p>
              ...
              <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-5 text-lg leading-8 text-titanium/[0.78]">
                    ...
                    detection, attestation, guardian challenge, and blocked execution.
                  </p>
                </div>
                <div className="rounded-2xl border border-arctic/[0.20] bg-arctic/[0.08] p-6">
                  <p className="font-mono text-xs font-bold uppercase tracking-[0.25em] text-arctic">Start here</p>
